...
<?php if ($correctoNormal) { ?>
	...
	<p>Se ha eliminado correctamente la marca.</p>

<?php } else if ($noExistia) { ?>

	<h1>Eliminación no realizada</h1>
	<p>No existe la marca que se pretende eliminar (quizá la eliminaron en paraleo o, ¿ha manipulado Vd. el parámetro id?).</p>

<?php } else { ?>

	<h1>Error en la eliminación</h1>
	<p>No se ha podido eliminar la marca.</p>

<?php } ?>

<a href='MarcaListado.php'>Volver al listado de marcas.</a>
